...
# manualbutton.rect.x = 240
# manualbutton.rect.y = 240
...
def scene_authors():
    ...
    quitBtn.image = pygame.image.load("sprites/back.png")
...
def scene_main_menu():  # сцена главного меню
...
def pause_menu(scene):
    ...
    backBtn.image = pygame.image.load("sprites/back.png")
...
scene_main_menu() # сначала включается сцена главного меню
